 ...
 * @author dummy
 */
public class Dlg_baptism extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_baptism(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_baptism(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }
    ...
    private Dlg_baptism myRef;

    private void setThisRef(Dlg_baptism myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_baptism> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_baptism create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_baptism create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_baptism dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_baptism((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_baptism((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_baptism dialog = Dlg_baptism.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 197, 930, 570));
        ...
        jPanel1.add(cb_status, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 140, 240, 35));

        jLabel1.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel1.setText("SEARCH:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, 39));
        ...
        jPanel1.add(tf_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 586, 37));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 140, 77, 37));
        ...
        jPanel1.add(jc_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 40, 230, 34));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 140, -1, 40));

        jLabel3.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel3.setText("TIME:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 90, -1, 30));
        ...
        jPanel1.add(cb_time, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 90, 270, 33));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 40, -1, 31));
...
//        String name = tf_searc.getText();
        ...
        loadData_baptism(S8_baptism.do_ret_baptized(is_approved, is_payed, is_married, name));
    }
...
//        String name = tf_searc.getText();
        ...
        if (jj == 0) {
            ...
            loadData_baptism(S8_baptism.do_ret_baptized_by_date(is_approved, is_payed, is_married, name, date, time));
        }
...
//                ," book_number","page_number"," date_added"," date_modified"
        ...
        final String baptism_number = tbl_baptism.getModel().getValueAt(row, 0).toString();
...
//        nd.do_pass(to);
        nd.setCallback(new Dlg_confirm.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_confirm.OutputData data) {
                closeDialog.ok();
                approve_baptism(baptism_number);
                data_bap();
                clear();
            }
        });
    ...
    private void approve_baptism(String baptismal_number) {
        S8_baptism.approve_baptism(baptismal_number);
    }
...
//        nd.do_pass(to);
        nd.setCallback(new Dlg_confirm.Callback() {
            ...
            public void ok(CloseDialog closeDialog, Dlg_confirm.OutputData data) {
                closeDialog.ok();
                confirm_baptism(baptism_number);
                data_bap();
                clear();
            }
        });
    ...
    private void confirm_baptism(String baptismal_number) {
        S8_baptism.confirm_baptism(baptismal_number);
    }
...
//          TableWidthUtilities.
    ...
    private void loadData_sponsors(List<S8_baptism.to_sponsors> acc) {
        tbl_sponsors_ALM.clear();
...
//            }
    ...
    private void data_sponsors() {
        ...
        String baptism_number = tbl_baptism.getModel().getValueAt(row, 0).toString();
        loadData_sponsors(S8_baptism.ret_data(baptism_number));
