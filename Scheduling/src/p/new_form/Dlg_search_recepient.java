 ...
 * @author dummy
 */
public class Dlg_search_recepient extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_search_recepient(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_search_recepient(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    public Dlg_search_recepient() {
        super();
        initComponents();
        myInit();

    }
    private Dlg_search_recepient myRef;

    private void setThisRef(Dlg_search_recepient myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_search_recepient> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_search_recepient create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_search_recepient create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_search_recepient dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_search_recepient((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_search_recepient((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
...
//            UIManager.setLookAndFeel(ch.randelshofer.quaqua.QuaquaManager.getLookAndFeel());
        ...
        Dlg_search_recepient dialog = Dlg_search_recepient.create(new javax.swing.JFrame(), true);
...
//            do_check_date();
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(tf_search, javax.swing.GroupLayout.PREFERRED_SIZE, 390, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(101, 101, 101)
                .addComponent(pnl_help, javax.swing.GroupLayout.PREFERRED_SIZE, 458, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(pnl_help, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
    ...
    private void myInit() {
        dp_date_from.setDate(new Date());
        dp_date_to.setDate(new Date());
        tf_search.grabFocus();
        init_date();
        init_date_to();
        init_key();
...
//          TableWidthUtilities.
        ...
        Dimension d = tbl_name.getTableHeader().getPreferredSize();
        d.height = 30;
        tbl_name.getTableHeader().setPreferredSize(d);
        ...
        tbl_name.getTableHeader().setFont(new java.awt.Font("Arial", Font.BOLD, 12));
...
//           "Ref #", "First Name", "Middle Name", "Last Name", "Gender", "Date of Baptism", "Date of Birth", "Place of Birth", "Address 1", "Address 2", "City", "State", "Zip Code", "Father", "Mother", "is_baptized", "is_comm", "is_confirm", "is_married", "is_2nd_married", "is_prof_faith", "is_acceptance", "is_death", "Date Added"
        ...
        String ref_id = tbl_name.getModel().getValueAt(row, 0).toString();
        String fname = tbl_name.getModel().getValueAt(row, 1).toString();
        String mi = tbl_name.getModel().getValueAt(row, 2).toString();
        String lname = tbl_name.getModel().getValueAt(row, 3).toString();
        String date_of_baptism = tbl_name.getModel().getValueAt(row, 5).toString();
        String date_of_birth = tbl_name.getModel().getValueAt(row, 6).toString();
        String place_of_birth = tbl_name.getModel().getValueAt(row, 7).toString();
        String address1 = tbl_name.getModel().getValueAt(row, 8).toString();
        String address2 = tbl_name.getModel().getValueAt(row, 9).toString();
        String city = tbl_name.getModel().getValueAt(row, 10).toString();
        String states = tbl_name.getModel().getValueAt(row, 11).toString();
        String zip_code = tbl_name.getModel().getValueAt(row, 12).toString();
        String father = tbl_name.getModel().getValueAt(row, 13).toString();
        String mother = tbl_name.getModel().getValueAt(row, 14).toString();
        String is_baptized = tbl_name.getModel().getValueAt(row, 15).toString();
        String is_comm = tbl_name.getModel().getValueAt(row, 16).toString();
        String is_confirm = tbl_name.getModel().getValueAt(row, 17).toString();
        String is_married = tbl_name.getModel().getValueAt(row, 18).toString();
        String is_2nd_married = tbl_name.getModel().getValueAt(row, 19).toString();
        String is_prof_faith = tbl_name.getModel().getValueAt(row, 20).toString();

        String is_acceptance = tbl_name.getModel().getValueAt(row, 21).toString();
        String is_death = tbl_name.getModel().getValueAt(row, 22).toString();
        String date_added = tbl_name.getModel().getValueAt(row, 23).toString();

        String gender = tbl_name.getModel().getValueAt(row, 4).toString();
        String bapt_church = tbl_name.getModel().getValueAt(row, 24).toString();
...
//           "Ref #", "First Name", "Middle Name", "Last Name", "Gender", "Date of Baptism", "Date of Birth", "Place of Birth", "Address 1", "Address 2", "City", "State", "Zip Code", "Father", "Mother", "is_baptized", "is_comm", "is_confirm", "is_married", "is_2nd_married", "is_prof_faith", "is_acceptance", "is_death", "Date Added"
        ...
        final String ref_id = tbl_name.getModel().getValueAt(row, 0).toString();
        String fname = tbl_name.getModel().getValueAt(row, 1).toString();
        String mi = tbl_name.getModel().getValueAt(row, 2).toString();
        String lname = tbl_name.getModel().getValueAt(row, 3).toString();
        ...
        final String gender = tbl_name.getModel().getValueAt(row, 4).toString();
        Window p = (Window) this;
...
//            }
    ...
    private void do_certificate(final List<String> sac) {
        ...
        final String ref_no = tbl_name.getModel().getValueAt(row, 0).toString();
