 ...
 * @author dummy
 */
public class Dlg_new_marr_sponsors extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public final List<Dlg_new_marriages.to_marriage_sponsors> wit;

        public OutputData(List<Dlg_new_marriages.to_marriage_sponsors> wit) {
            this.wit = wit;
        }
    }
//</editor-fold>
    ...
    private Dlg_new_marr_sponsors(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_new_marr_sponsors(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    public Dlg_new_marr_sponsors() {
        super();
        initComponents();
        myInit();

    }
    private Dlg_new_marr_sponsors myRef;

    private void setThisRef(Dlg_new_marr_sponsors myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_new_marr_sponsors> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_new_marr_sponsors create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_new_marr_sponsors create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_new_marr_sponsors dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_new_marr_sponsors((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_new_marr_sponsors((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_new_marr_sponsors dialog = Dlg_new_marr_sponsors.create(new javax.swing.JFrame(), true);
    ...
    public void not_yet_added(String name, String id, List<Dlg_new_marriages.to_marriage_sponsors> sponsors_ALM) {
        ref_nos = id;
        lbl_name.setText(name);
...
//          TableWidthUtilities.
    ...
    private void loadData_baptism(List<Dlg_new_marriages.to_marriage_sponsors> acc) {
...
//            }
        ...
        public Object getValueAt(int row, int col) {
           Dlg_new_marriages.to_marriage_sponsors tt = (Dlg_new_marriages.to_marriage_sponsors) getRow(row);
