 ...
 * @author dummy
 */
public class Dlg_new_communion extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public final to_communion to_comm;

        public OutputData(to_communion to_comm) {
            this.to_comm = to_comm;
        }
    }
//</editor-fold>

    //<editor-fold defaultstate="collapsed" desc=" Constructors ">
    private Dlg_new_communion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_new_communion(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    public Dlg_new_communion() {
        super();
        initComponents();
        myInit();

    }
    private Dlg_new_communion myRef;

    private void setThisRef(Dlg_new_communion myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_new_communion> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_new_communion create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_new_communion create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_new_communion dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_new_communion((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_new_communion((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_new_communion dialog = Dlg_new_communion.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        dp_commdate = new com.toedter.calendar.JDateChooser();
        ...
        jLabel1.setText("COMMUNION INFORMATION");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 24, 1170, -1));
        ...
        jLabel34.setText("Communion Date:");
        jPanel3.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 140, 30));

        jLabel35.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel35.setText("Time:");
        jPanel3.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 110, 110, 30));

        cb_time.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel3.add(cb_time, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 110, 370, 30));

        jLabel18.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel18.setText("Priest:");
        jPanel3.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 110, 30));

        cb_priest.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jPanel3.add(cb_priest, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 144, 370, 30));

        jLabel37.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel37.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel37.setText("Presider:");
        jPanel3.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 188, 110, 30));
        ...
        jPanel3.add(tf_presider, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 190, 370, 30));
        ...
        jPanel3.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 260, 360, 80));

        jLabel25.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel25.setText("Remarks:");
        jPanel3.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, 110, 30));
        jPanel3.add(dp_commdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 79, 260, 30));

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 90, 570, 380));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 550, 430));
        ...
        jPanel1.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 480, 100, 40));
        ...
        jPanel1.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 480, 100, 40));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 480, 100, 40));
        ...
        jPanel1.add(btn_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 480, 100, 40));
    ...
    private com.toedter.calendar.JDateChooser dp_commdate;
    ...
    private void myInit() {
        ...
        dp_commdate.setDate(new Date());
        
         S3_cb_convenience.cb_init(cb_priest, S3_cb_convenience.s_priest);

        S3_cb_convenience.cb_init(cb_time, S3_cb_convenience.s_time_comm);
    ...
    public void do_pass1(String ref_no) {
        ...
        lbl_ref_no.setText(ref_no);
        to_communion to = S2_new_communion.get_details(ref_no);
...
//         
        ...
        try {
            ...
            dp_commdate.setDate(DateType.sf.parse(to.comm_date));
        } catch (ParseException ex) {
            Logger.getLogger(Dlg_new_communion.class.getName()).log(Level.SEVERE, null, ex);
        }
//        
    ...
    public static class to_communion {
        ...
        public to_communion(String fname, String mi, String lname, String bday, String place_of_birth, String bapt_date, String bapt_place, String book_no, String page_no, String comm_date, String time, String priest, String presider, String remarks, String father, String mother) {
            this.fname = fname;
            this.mi = mi;
            this.lname = lname;
            this.bday = bday;
...
//                btn_0.doClick();
    ...
    private void ok1() {
        ...
        String comm_date = DateType.sf.format(dp_commdate.getDate());
        ...
        final to_communion to = new to_communion(fname, mi, lname, bday, place_of_birth, bapt_date, bapt_place, book_no, page_no, comm_date, time, priest, presider, remarks, father, mother);
        if (callback != null) {
    ...
    private void do_edit(to_communion to) {
        callback.edit(new CloseDialog(this), new OutputData(to));
    }

    private void do_delete(to_communion to) {
