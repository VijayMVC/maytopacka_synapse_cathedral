 ...
 * @author dummy
 */
public class Dlg_choose_confirm_1 extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_choose_confirm_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_choose_confirm_1(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    public Dlg_choose_confirm_1() {
        super();
        initComponents();
        myInit();

    }
    private Dlg_choose_confirm_1 myRef;

    private void setThisRef(Dlg_choose_confirm_1 myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_choose_confirm_1> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_choose_confirm_1 create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_choose_confirm_1 create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_choose_confirm_1 dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_choose_confirm_1((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_choose_confirm_1((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_choose_confirm_1 dialog = Dlg_choose_confirm_1.create(new javax.swing.JFrame(), true);
