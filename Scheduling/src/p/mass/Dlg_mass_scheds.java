 ...
 * @author Dummy
 */
public class Dlg_mass_scheds extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_mass_scheds(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    private Dlg_mass_scheds(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        myInit();
    }

    public Dlg_mass_scheds() {
        super();
        initComponents();
        myInit();

    }
    private Dlg_mass_scheds myRef;

    private void setThisRef(Dlg_mass_scheds myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_mass_scheds> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_mass_scheds create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_mass_scheds create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_mass_scheds dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_mass_scheds((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_mass_scheds((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_mass_scheds dialog = Dlg_mass_scheds.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        cb_type.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Thanks Giving", "Petition Mass", "Common", "Requiem", "Baptism", "Confirmation", "Marriage", "Funeral" }));
...
//        tbl_advances.setAutoResizeMode(0);
    ...
    private void loadData_advances(List<S1_mass.to_schedules> acc) {
...
//            }
        ...
        public Object getValueAt(int row, int col) {
            S1_mass.to_schedules tt = (S1_mass.to_schedules) getRow(row);
...
//         JOptionPane.showMessageDialog(null,ad_id);
        loadData_advances(S1_mass.ret_scheds(type));
    }

    private void add() {
        Window p = (Window) this;
        Dlg_add_time nd = Dlg_add_time.create(p, true);
        nd.setTitle("");
//        nd.do_pass("");
        nd.setCallback(new Dlg_add_time.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_add_time.OutputData data) {
                closeDialog.ok();
                do_add(data.time);
                data_time();
            }
    ...
    private void do_add(String time) {
        String type = cb_type.getSelectedItem().toString();
        S1_mass.add_schedule(time, type);
