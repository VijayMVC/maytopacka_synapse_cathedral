...
import bb.svc2.S4_delete_user;
import bb.svc2.S5_delete_user;
...
//            validateTree();
    ...
    private void initComponents() {
        ...
        cb_role.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Administrator", "Scheduler", "Cashier", "Encoder" }));
        ...
        jPanel1.add(btn_ok, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 290, 80, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(487, 290, 80, 40));
...
//          TableWidthUtilities.
        ...
        tbl_users.getTableHeader().setFont(new java.awt.Font("Arial", Font.BOLD, 12));
...
//       
    ...
    private void insert_new_user() {
        ...
        int user_level = 0;
        if (tf_name.getText().isEmpty() || tb_username.getText().isEmpty()) {
        ...
        if (cb_role.getSelectedIndex() == 2) {
            user_level = 2;
        }
        if (cb_role.getSelectedIndex() == 3) {
            user_level = 3;
        }
        if (trigger == 0) {
...
//            JOptionPane.showMessageDialog(null, "saved");
            ...
            if (row < 0) {
                ...
                String cur_user = tbl_users.getModel().getValueAt(row, 0).
                        toString();
...
//          JOptionPane.showMessageDialog(null,"update");
    ...
    private void edit() {
        ...
        if (row < 0) {
            ...
            String user_name = tbl_users.getModel().getValueAt(row, 0).toString();
//          
            String name = tbl_users.getModel().getValueAt(row, 2).toString();
