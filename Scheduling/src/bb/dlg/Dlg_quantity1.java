...
//            validateTree();
    ...
    private void initComponents() {
        ...
        pnl_floor.add(pnl_numpad, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 130, 480, 450));
        ...
        pnl_floor.add(pnl_payment, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 390, 450));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(pnl_floor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 900, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnl_floor, javax.swing.GroupLayout.PREFERRED_SIZE, 602, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
//        });
    ...
    private void prcss_work_on() {
        ...
        callback.ok(new CloseDialog(this), new Dlg_quantity1.OutputData(lb_ref_no.getText()));
        this.dispose();
    }
    JTextField tf_dummy;
...
//            CashDrawer.open();
    ...
    private void ok1() {
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(lb_ref_no.getText()));
        }
    }
